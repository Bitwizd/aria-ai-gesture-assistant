...
def draw_target(
    ...
    if confirmed:
        ...
        target_color = BRIGHT_CYAN
    else:
        target_color = BRIGHT_CYAN

    glow = frame.copy()

    outer_radius = 45 if locked else 35
...
print("==========================================")
print()
print("POINTING   = Move target")
print("FIST       = Lock target")
print("THUMBS UP  = Confirm")
print("OPEN PALM  = Scan")
...
with HandLandmarker.create_from_options(
    ...
    while True:
        ...
        # ====================================================
        # UNLOCK WHEN POINTING AFTER LOCK
        # ====================================================
        ...
        if time.time() < confirmation_until:

            confirmation_radius = int(
                50 +
                (0.6 - (
                    confirmation_until -
                    time.time()
